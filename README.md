...
- 📚 **Coursework projects** (school assignments and documentation)
  ...
  - Softcomputing / Machine Learning – tomato yield vs vitality
  - Software engineering documentation (AI summarizer, smart building, etc.)
...
## 🧠 Technologies Used
- Python (qrcode, file handling)
- C (structures, file operations)
